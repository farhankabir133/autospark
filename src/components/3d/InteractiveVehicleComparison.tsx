...
import { ChevronDown, Zap, Fuel, Gauge, Users, Wrench } from 'lucide-react';
...
export const InteractiveVehicleComparison: React.FC<InteractiveVehicleComparisonProps> = ({
  ...
  const [viewMode, setViewMode] = useState<'all' | '3d'>('all');
  ...
  const toggleVehicleSelection = (vehicleId: string) => {
    setSelectedVehicles((prev) =>
      prev.includes(vehicleId) ? prev.filter((id) => id !== vehicleId) : [...prev, vehicleId].slice(-3)
    );
  };
  ...
  return (
    ...
    >
      ...
      <div className="p-6 md:p-8 border-b border-gray-200">
        <h3 className="text-lg font-bold text-gray-900 mb-4">Select Vehicles to Compare</h3>
