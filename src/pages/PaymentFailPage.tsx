  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-lg rounded-2xl border border-white/10 bg-white/5 p-6">
        ...
        <p className="mt-6 text-white/80">Your payment wasn’t completed. You can try again from the cart.</p>

        <div className="mt-6 flex gap-3">
          <Link className="px-4 py-2 rounded-lg bg-[#C00000] hover:brightness-110" to="/accessories">Try again</Link>
