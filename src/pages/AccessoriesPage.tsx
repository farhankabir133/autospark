...
const demoProducts: AccessoryProduct[] = [
  ...
  { id: '1025', name_en: 'CVT Fluid NS-3', name_bn: '', price: 6950, category: 'Accessories', stock_quantity: 10, is_available: true, images: [{ image_url: '/cars/Products/NS3.jpeg' }], brand: '', rating: 0, reviews: 0, discount: 0, compatibility: [], isNew: false, isBestseller: false },
  ...
  { id: '1062', name_en: 'Globoil 0W-20', name_bn: '', price: 4250, category: 'Accessories', stock_quantity: 10, is_available: true, images: [{ image_url: '/cars/Products/Globoil-PAO-0W20.jpeg' }], brand: '', rating: 0, reviews: 0, discount: 0, compatibility: [], isNew: false, isBestseller: false },
  { id: '1063', name_en: 'Globoil 10W-40', name_bn: '', price: 4050, category: 'Accessories', stock_quantity: 10, is_available: true, images: [{ image_url: '/cars/Products/Globoil-PAO-0W20.jpeg' }], brand: '', rating: 0, reviews: 0, discount: 0, compatibility: [], isNew: false, isBestseller: false },
  { id: '1064', name_en: 'Globoil PAO 0W-20', name_bn: '', price: 5750, category: 'Accessories', stock_quantity: 10, is_available: true, images: [{ image_url: '/cars/Products/Globoil-PAO-0W20.jpeg' }], brand: '', rating: 0, reviews: 0, discount: 0, compatibility: [], isNew: false, isBestseller: false },
  ...
  { id: '1092', name_en: 'Mobil 1-0W20', name_bn: '', price: 6950, category: 'Accessories', stock_quantity: 10, is_available: true, images: [{ image_url: '/cars/Products/Mobil1-0W20.jpeg' }], brand: '', rating: 0, reviews: 0, discount: 0, compatibility: [], isNew: false, isBestseller: false },
  ...
  { id: '1094', name_en: 'Mobil Filter 31000', name_bn: '', price: 650, category: 'Accessories', stock_quantity: 10, is_available: true, images: [{ image_url: '/cars/Products/Filter.jpeg' }], brand: '', rating: 0, reviews: 0, discount: 0, compatibility: [], isNew: false, isBestseller: false },
  { id: '1095', name_en: 'Mobil Filter 40060', name_bn: '', price: 350, category: 'Accessories', stock_quantity: 10, is_available: true, images: [{ image_url: '/cars/Products/Filter.jpeg' }], brand: '', rating: 0, reviews: 0, discount: 0, compatibility: [], isNew: false, isBestseller: false },
  { id: '1096', name_en: 'Mobil Filter 65F00', name_bn: '', price: 650, category: 'Accessories', stock_quantity: 10, is_available: true, images: [{ image_url: '/cars/Products/Filter.jpeg' }], brand: '', rating: 0, reviews: 0, discount: 0, compatibility: [], isNew: false, isBestseller: false },
  ...
  { id: '1111', name_en: 'Prado Air Filter', name_bn: '', price: 700, category: 'Accessories', stock_quantity: 10, is_available: true, images: [{ image_url: '/cars/Products/Filter.jpeg' }], brand: '', rating: 0, reviews: 0, discount: 0, compatibility: [], isNew: false, isBestseller: false },
  ...
  {
    id: '13',
    name_en: 'Mobil 1 Advanced Full Synthetic 0W-20',
    name_bn: 'মোবিল ১ অ্যাডভান্সড ফুল সিনথেটিক 0W-20',
    description_en: 'Mobil 1 0W-20 offers outstanding engine protection and enhanced fuel economy. Ideal for modern engines requiring low-viscosity oil.',
    description_bn: 'মোবিল ১ 0W-20 অসাধারণ ইঞ্জিন সুরক্ষা এবং উন্নত জ্বালানি সাশ্রয় প্রদান করে।',
    category: 'Oils & Lubricants',
    price: 4500,
    stock_quantity: 120,
    is_available: true,
  images: [{ image_url: '/cars/Products/OctaneBooster.jpeg' }],
    brand: 'Mobil 1',
    rating: 4.9,
    reviews: 523,
    discount: 10,
    compatibility: ['Toyota', 'Honda', 'Lexus', 'Hyundai', 'Kia'],
    isNew: false,
    isBestseller: true
  },
  {
  ...
  {
    id: '15',
    name_en: 'Mobil 1 High Mileage 10W-40',
    name_bn: 'মোবিল ১ হাই মাইলেজ 10W-40',
    description_en: 'Mobil 1 10W-40 is designed for engines with over 75,000 miles. Contains seal conditioners to help prevent leaks.',
    description_bn: 'মোবিল ১ 10W-40 ৭৫,০০০ মাইলের বেশি ইঞ্জিনের জন্য ডিজাইন করা হয়েছে।',
    category: 'Oils & Lubricants',
    price: 4000,
    stock_quantity: 65,
    is_available: true,
    ...
    reviews: 256,
    discount: 0,
    compatibility: ['High Mileage Engines', 'Universal'],
    isNew: false,
    isBestseller: false
  },
  // GULF OIL
  ...
  // GLOBOIL (Bangladesh Brand)
  {
    id: '19',
    name_en: 'Globoil Premium 0W-20 Synthetic',
    name_bn: 'গ্লোবয়েল প্রিমিয়াম 0W-20 সিনথেটিক',
    description_en: 'Globoil 0W-20 full synthetic oil specially formulated for fuel-efficient engines. API SN Plus certified.',
    description_bn: 'জ্বালানি-দক্ষ ইঞ্জিনের জন্য বিশেষভাবে তৈরি গ্লোবয়েল 0W-20 ফুল সিনথেটিক অয়েল।',
    category: 'Oils & Lubricants',
    price: 3500,
    stock_quantity: 150,
    is_available: true,
  ...
  {
    id: '20',
    name_en: 'Globoil Ultra 10W-30 Synthetic Blend',
  ...
  {
    id: '21',
    name_en: 'Globoil Power 10W-40 Mineral',
    name_bn: 'গ্লোবয়েল পাওয়ার 10W-40 মিনারেল',
    description_en: 'Globoil 10W-40 mineral oil provides reliable protection for older engines at an economical price.',
    description_bn: 'গ্লোবয়েল 10W-40 মিনারেল অয়েল সাশ্রয়ী মূল্যে পুরোনো ইঞ্জিনের জন্য নির্ভরযোগ্য সুরক্ষা প্রদান করে।',
    category: 'Oils & Lubricants',
    price: 2200,
    stock_quantity: 180,
    is_available: true,
    ...
    reviews: 267,
    discount: 0,
    compatibility: ['Older Vehicles', 'Budget Maintenance'],
    isNew: false,
    isBestseller: true
  },
  ...
  {
    id: '60',
    name_en: 'Mobil 1 0W-20',
    name_bn: 'মোবিল ১ 0W-20',
    description_en: 'Premium full synthetic motor oil for advanced fuel economy and engine protection.',
    description_bn: 'উন্নত জ্বালানি সাশ্রয় এবং ইঞ্জিন সুরক্ষার জন্য প্রিমিয়াম ফুল সিনথেটিক মোটর অয়েল।',
    category: 'Oils & Lubricants',
    price: 6850,
    stock_quantity: 60,
    is_available: true,
    ...
    reviews: 567,
    discount: 5,
    compatibility: ['Toyota', 'Honda', 'Lexus', 'Hybrid Vehicles'],
    isNew: false,
    isBestseller: true
  },
  {
  ...
  {
    id: '62',
    name_en: 'Toyota Mobil',
    name_bn: 'টয়োটা মোবিল',
    description_en: 'Genuine Toyota motor oil specially formulated for Toyota engines.',
    description_bn: 'টয়োটা ইঞ্জিনের জন্য বিশেষভাবে তৈরি আসল টয়োটা মোটর অয়েল।',
    category: 'Oils & Lubricants',
    price: 3950,
    stock_quantity: 70,
    is_available: true,
  ...
  {
    id: '63',
    name_en: 'Mobil Globoil',
    name_bn: 'মোবিল গ্লোবয়েল',
    description_en: 'Premium engine oil for superior engine protection and performance.',
    description_bn: 'উচ্চতর ইঞ্জিন সুরক্ষা এবং পারফরম্যান্সের জন্য প্রিমিয়াম ইঞ্জিন অয়েল।',
    category: 'Oils & Lubricants',
    price: 4200,
    stock_quantity: 55,
    is_available: true,
  ...
  {
    id: '66',
    name_en: 'Gulf Multi GTS Mobil',
    name_bn: 'গাল্ফ মাল্টি জিটিএস মোবিল',
    description_en: 'Multi-grade motor oil for all-season protection and performance.',
    description_bn: 'সব সিজন সুরক্ষা এবং পারফরম্যান্সের জন্য মাল্টি-গ্রেড মোটর অয়েল।',
    category: 'Oils & Lubricants',
    price: 1750,
    stock_quantity: 90,
    is_available: true,
