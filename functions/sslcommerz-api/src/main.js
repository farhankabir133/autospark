  ...
  if (req.path === '/init' && req.method === 'POST') {
    try {
      ...
      const data = {
        ...
        success_url: `${req.headers.origin || process.env.BASE_URL || 'https://autosparkbd.com'}/payment-success`,
        fail_url: `${req.headers.origin || process.env.BASE_URL || 'https://autosparkbd.com'}/payment-fail`,
        cancel_url: `${req.headers.origin || process.env.BASE_URL || 'https://autosparkbd.com'}/payment-cancel`,
